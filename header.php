    ...
    <header class="header" data-header>
        <div class="container">
          ...
          <ion-icon name="close-sharp" aria-hidden="true"></ion-icon>
            ...
            <a href="./login form/register_form.php" class="btn btn-secondary">Join Now</a>
                    ...
                    <ul class="blog-list has-scrollbar">
                        ...
                        <li class="scrollbar-item">
                            <div class="blog-card">
                                ...
                                <div class="card-banner img-holder" style="--width: 440; --height: 270;">
                                    <img src="./assets/images/blog-1.jpg" width="440" height="270" loading="lazy" alt="Going to the gym for the first time" class="img-cover">
                        ...
                        <li class="scrollbar-item">
                            <div class="blog-card">
                                ...
                                <div class="card-banner img-holder" style="--width: 440; --height: 270;">
                                    <img src="./assets/images/blog-2.jpg" width="440" height="270" loading="lazy" alt="Parturient accumsan cacus pulvinar magna" class="img-cover">
                        ...
                        <li class="scrollbar-item">
                            <div class="blog-card">
                                ...
                                <div class="card-banner img-holder" style="--width: 440; --height: 270;">
                                    <img src="./assets/images/blog-3.jpg" width="440" height="270" loading="lazy" alt="Risus purus namien parturient accumsan cacus" class="img-cover">
